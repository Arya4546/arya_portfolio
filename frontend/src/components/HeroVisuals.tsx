    ...
    return (
        <div className="flex flex-col gap-3 w-full max-w-lg">
            <motion.div
                ...
                className="w-full rounded-2xl overflow-hidden border border-foreground/10 bg-accent/5 backdrop-blur-md shadow-2xl relative"
            >
                {/* Window Header */}
            ...
            {/* Live Activity Status — companion widget below the terminal */}
            <LiveStatusWidget />
        </div>
    );
};
