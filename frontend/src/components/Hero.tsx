...
const Hero = () => {
    return (
        <section id="hero" className="relative h-screen lg:fixed lg:inset-0 lg:h-[100dvh] flex items-center justify-center overflow-hidden bg-background pt-28 lg:pt-0 pb-12 lg:pb-0">
