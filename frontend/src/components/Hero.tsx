...
const Hero = () => {
    return (
        <section id="hero" className="relative h-screen lg:fixed lg:inset-0 lg:h-[100dvh] flex items-center justify-center overflow-hidden bg-background pt-20 lg:pt-0 pb-16 lg:pb-0">
